    ...
    <Fragment>
      {
        window.screen.width > 1024 ?
          ...
          <Fragment>
            ...
            {/* <div >
            <h1 className='text-3xl px-8 font-bold font1 tracking-widest text-slate-800 mb-8'>YOU HAVE CREATED YOUR AVATAR SUCCESSFULLY!!</h1>
              <div className='grid grid-cols-8' style={{ textAlign: 'center' }}>
                <Link to='/products'>
                  <LazyLoadImage effect='blur' src={av2} alt="" className="min-h-[200px]" style={{ textAlign: 'center', marginLeft: '350%' }} />
                </Link>
              </div>
            </div> */}
    ...
    {/* <div className="giftcontainer">
        <div className="gift">
           ...
           <label htmlFor="click" className="click"   ></label>
            ...
            <div>
              <h1 className='text-3xl px-8 font-bold font1 tracking-widest text-slate-800 mb-8 mt-8'>BEST SELLING PRODUCTS</h1>
